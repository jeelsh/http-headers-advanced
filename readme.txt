...
The plugin source code and build tooling are maintained at https://github.com/jeelsh/http-headers-advanced.
...
No. Header configuration and validation run within your WordPress installation.
