  ...
  return (
    <aside className="w-72 p-5 border-l border-border bg-background">
      <h3 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground mb-3">
        {__('Soporte', 'jeelsh-http-headers')}
      </h3>
      <DashedLine position="bottom" assetBaseUrl={assetBaseUrl} isDark={isDark} className="mb-4" />
      <p className="text-sm text-muted-foreground mb-4">
        {__('¿Necesitas ayuda? Consulta la documentación o contacta con soporte para resolver tus dudas.', 'jeelsh-http-headers')}
      </p>
      <div className="space-y-2">
        ...
        >
          ...
          {__('Documentación', 'jeelsh-http-headers')}
        </Button>
      </div>
    </aside>
  );
